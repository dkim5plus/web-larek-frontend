...
- getCardPreview - выбор товара для отображения в модальном окне
...
- isProductInCart - проверяет наличие товара в корзине
...
### Класс FormEnd
Для работы с формой уведомления о заказе.
Методы:
